...
<body>
    ...
    <header>
        ...
        <h1><a href="member.jsp?section=home">세명 병원</a></h1>
    </header>
    <div id="loop">
    ...
    <nav>
        <ul>
            <li><a href="member.jsp?section=enroll" >의료진</a></li>
            <li><a href="member.jsp?section=sales" >봉사활동</a></li>
            <li><a href="member.jsp?section=shopsales" >예약</a></li>
            <li><a href="member.jsp?section=productsales">병원소개</a></li>
        </ul>
    </nav>
    <div id="login">
    <%String logid=request.getParameter("logid"); %>
    	<p><%=logid %>님 <br>환영합니다</p>
    </div>
    <section>
<%
switch(section){
case"enroll":%>
<jsp:include page="nav/dmltk.jsp"></jsp:include>
<%
break;
case"sales":%>
...
break;
case"shopsales":%>
<jsp:include page="nav/dpdir.jsp"></jsp:include>
<%
break;
case"productsales":%>
